...
ALLOWED_HOSTS = ['cadeuracha.up.railway.app', 'localhost', '127.0.0.1']

CSRF_TRUSTED_ORIGINS = ['https://cadeuracha.up.railway.app/']

CORS_ALLOWED_ORIGINS = ['https://cadeuracha.up.railway.app/']
